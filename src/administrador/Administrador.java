...
public class Administrador extends javax.swing.JFrame {
   ...
   Connection Nuevo=conectar.getConection();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 383, 162, 80));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 43, 30));
...
public void Eliminar(){
    ...
    eliminar.setSize(920,600);
    eliminar.setLocation(0,0);
    MOSTRAR.removeAll();
    MOSTRAR.add(eliminar,BorderLayout.CENTER);
    MOSTRAR.revalidate();
    MOSTRAR.repaint();
}
